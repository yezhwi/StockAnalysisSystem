...
public class AIShowAdapter extends BaseAdapter {
    static Stock stock=new Stock();

    String gid;
    private List<aiStock>list;
    private Context context;
    //private LayoutInflater inflater;
    private String categoryID;
    public AIShowAdapter(Context context, List<aiStock> list1, String category){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        aiStock aiStock1=list.get(position);

        //2.获取view上的子控件对象
        TextView aiStock_name=(TextView)view.findViewById(R.id.health_china_stock_name);
        TextView aiStock_symbol=(TextView)view.findViewById(R.id.health_china_stock_symbol);
        TextView aiStock_now_price=(TextView)view.findViewById(R.id.health_china_now_price);
        TextView aiStock_change_price=(TextView)view.findViewById(R.id.health_china_change_price);
        TextView aiStock_change_percent=(TextView)view.findViewById(R.id.health_china_change_percent);
        TextView aiStock_theme_name=(TextView)view.findViewById(R.id.health_china_theme_name);
        ...
        //4.将数据设置给这些子控件做显示
        aiStock_name.setText(aiStock1.getName());
        aiStock_symbol.setText(aiStock1.getGid());
        aiStock_now_price.setText(stock.getTrade());
        aiStock_change_price.setText(stock.getPricechange());
        aiStock_change_percent.setText(stock.getChangepercent());
        aiStock_theme_name.setText(categoryID);
