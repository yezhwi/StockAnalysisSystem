...
public class FiveGStockAdapter extends BaseAdapter {
    static Stock stock=new Stock();

    String gid;
    private List<fgStock>list;
    private Context context;
    private LayoutInflater inflater;
    private String categoryID;
    public FiveGStockAdapter(Context context, List<fgStock> list1, String category){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        fgStock fgStock1=list.get(position);

        //2.获取view上的子控件对象
        TextView fgStock_name=(TextView)view.findViewById(R.id.health_china_stock_name);
        TextView fgStock_symbol=(TextView)view.findViewById(R.id.health_china_stock_symbol);
        TextView fgStock_now_price=(TextView)view.findViewById(R.id.health_china_now_price);
        TextView fgStock_change_price=(TextView)view.findViewById(R.id.health_china_change_price);
        TextView fgStock_change_percent=(TextView)view.findViewById(R.id.health_china_change_percent);
        TextView fgStock_theme_name=(TextView)view.findViewById(R.id.health_china_theme_name);
        ...
        //4.将数据设置给这些子控件做显示
        fgStock_name.setText(fgStock1.getName());
        fgStock_symbol.setText(fgStock1.getGid());
        fgStock_now_price.setText(stock.getTrade());
        fgStock_change_price.setText(stock.getPricechange());
        fgStock_change_percent.setText(stock.getChangepercent());
        fgStock_theme_name.setText(categoryID);
        return view;
    }
}
