...
public class OneRoadStockAdapter extends BaseAdapter {
    static Stock stock=new Stock();

    String gid;
    private List<oneRoadStock>list;
    private Context context;
    private LayoutInflater inflater;
    private String categoryID;
    public OneRoadStockAdapter(Context context, List<oneRoadStock> list1, String category){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        oneRoadStock oneRoadStock1=list.get(position);

        //2.获取view上的子控件对象
        TextView oneRoadStock_name=(TextView)view.findViewById(R.id.health_china_stock_name);
        TextView oneRoadStock_symbol=(TextView)view.findViewById(R.id.health_china_stock_symbol);
        TextView oneRoadStock_now_price=(TextView)view.findViewById(R.id.health_china_now_price);
        TextView oneRoadStock_change_price=(TextView)view.findViewById(R.id.health_china_change_price);
        TextView oneRoadStock_change_percent=(TextView)view.findViewById(R.id.health_china_change_percent);
        TextView oneRoadStock_theme_name=(TextView)view.findViewById(R.id.health_china_theme_name);


        //3.获取postion位置条目对应的list集合中的新闻数据，Bean对象
        //tradeDB trade=list.get(position);
        gid=oneRoadStock1.getGid();
        ...
        //4.将数据设置给这些子控件做显示
        oneRoadStock_name.setText(oneRoadStock1.getName());
        oneRoadStock_symbol.setText(oneRoadStock1.getGid());
        oneRoadStock_now_price.setText(stock.getTrade());
        oneRoadStock_change_price.setText(stock.getPricechange());
        oneRoadStock_change_percent.setText(stock.getChangepercent());
        oneRoadStock_theme_name.setText(categoryID);
        return view;
    }
}
