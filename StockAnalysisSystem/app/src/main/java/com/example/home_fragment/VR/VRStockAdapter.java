...
public class VRStockAdapter extends BaseAdapter {
    static Stock stock=new Stock();

    String gid;
    private List<vrStock>list;
    private Context context;
    private LayoutInflater inflater;
    private String categoryID;
    public VRStockAdapter(Context context, List<vrStock> list1, String category){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vrStock vrStock1=list.get(position);

        //2.获取view上的子控件对象
        TextView vrStock_name=(TextView)view.findViewById(R.id.health_china_stock_name);
        TextView vrStock_symbol=(TextView)view.findViewById(R.id.health_china_stock_symbol);
        TextView vrStock_now_price=(TextView)view.findViewById(R.id.health_china_now_price);
        TextView vrStock_change_price=(TextView)view.findViewById(R.id.health_china_change_price);
        TextView vrStock_change_percent=(TextView)view.findViewById(R.id.health_china_change_percent);
        TextView vrStock_theme_name=(TextView)view.findViewById(R.id.health_china_theme_name);
        ...
        //4.将数据设置给这些子控件做显示
        vrStock_name.setText(vrStock1.getName());
        vrStock_symbol.setText(vrStock1.getGid());
        vrStock_now_price.setText(stock.getTrade());
        vrStock_change_price.setText(stock.getPricechange());
        vrStock_change_percent.setText(stock.getChangepercent());
        vrStock_theme_name.setText(categoryID);
        return view;
    }
}
