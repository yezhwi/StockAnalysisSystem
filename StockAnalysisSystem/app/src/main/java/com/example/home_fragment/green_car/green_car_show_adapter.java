...
public class green_car_show_adapter extends BaseAdapter {
    static Stock stock=new Stock();

    String gid;
    private List<greenCarStock>list;
    private Context context;
    private LayoutInflater inflater;
    private String categoryID;
    public green_car_show_adapter(Context context, List<greenCarStock> list1, String category){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        greenCarStock gcStock=list.get(position);

        //2.获取view上的子控件对象
        TextView green_car_stock_name=(TextView)view.findViewById(R.id.health_china_stock_name);
        TextView green_car_stock_symbol=(TextView)view.findViewById(R.id.health_china_stock_symbol);
        TextView green_car_now_price=(TextView)view.findViewById(R.id.health_china_now_price);
        TextView green_car_change_price=(TextView)view.findViewById(R.id.health_china_change_price);
        TextView green_car_change_percent=(TextView)view.findViewById(R.id.health_china_change_percent);
        TextView green_car_theme_name=(TextView)view.findViewById(R.id.health_china_theme_name);
        ...
        //4.将数据设置给这些子控件做显示
        green_car_stock_name.setText(gcStock.getName());
        green_car_stock_symbol.setText(gcStock.getGid());
        green_car_now_price.setText(stock.getTrade());
        green_car_change_price.setText(stock.getPricechange());
        green_car_change_percent.setText(stock.getChangepercent());
        green_car_theme_name.setText(categoryID);
