...
public class health_china_show_adapter extends BaseAdapter {
    static Stock stock=new Stock();

    String gid;
    private List<healthChinaStock>list;
    private Context context;
    private String categoryID;
    public health_china_show_adapter(Context context, List<healthChinaStock> list1, String category){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView!=null){
            ...
            view=layoutInflater.inflate(R.layout.health_china_list_layout,null);
            Log.i("convertView","为空");
        }
       // View view=inflater.inflate(R.layout.health_china_list_layout,null);
        healthChinaStock hcStock=list.get(position);

        //2.获取view上的子控件对象
        TextView health_china_stock_name=(TextView)view.findViewById(R.id.health_china_stock_name);
        TextView health_china_stock_symbol=(TextView)view.findViewById(R.id.health_china_stock_symbol);
        TextView health_china_now_price=(TextView)view.findViewById(R.id.health_china_now_price);
        TextView health_china_change_price=(TextView)view.findViewById(R.id.health_china_change_price);
        TextView health_china_change_percent=(TextView)view.findViewById(R.id.health_china_change_percent);
        TextView health_china_theme_name=(TextView)view.findViewById(R.id.health_china_theme_name);
        ...
        //4.将数据设置给这些子控件做显示
        health_china_stock_name.setText(hcStock.getName());
        health_china_stock_symbol.setText(hcStock.getGid());
        health_china_now_price.setText(stock.getTrade());
        health_china_change_price.setText(stock.getPricechange());
        health_china_change_percent.setText(stock.getChangepercent());
        health_china_theme_name.setText(categoryID);
