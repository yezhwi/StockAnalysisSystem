...
public class saveEnergyShowAdapter extends BaseAdapter {
    static Stock stock=new Stock();

    String gid;
    private List<saveEnergyStock>list;
    private Context context;
    private LayoutInflater inflater;
    private String categoryID;
    public saveEnergyShowAdapter(Context context, List<saveEnergyStock> list1, String category){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        saveEnergyStock seStock=list.get(position);

        //2.获取view上的子控件对象
        TextView saveEnergyStock_name=(TextView)view.findViewById(R.id.health_china_stock_name);
        TextView saveEnergyStock_symbol=(TextView)view.findViewById(R.id.health_china_stock_symbol);
        TextView saveEnergyStock_now_price=(TextView)view.findViewById(R.id.health_china_now_price);
        TextView saveEnergyStock_change_price=(TextView)view.findViewById(R.id.health_china_change_price);
        TextView saveEnergyStock_change_percent=(TextView)view.findViewById(R.id.health_china_change_percent);
        TextView saveEnergyStock_theme_name=(TextView)view.findViewById(R.id.health_china_theme_name);
        ...
        //4.将数据设置给这些子控件做显示
        saveEnergyStock_name.setText(seStock.getName());
        saveEnergyStock_symbol.setText(seStock.getGid());
        saveEnergyStock_now_price.setText(stock.getTrade());
        saveEnergyStock_change_price.setText(stock.getPricechange());
        saveEnergyStock_change_percent.setText(stock.getChangepercent());
        saveEnergyStock_theme_name.setText(categoryID);
