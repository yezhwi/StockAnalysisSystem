...
public class upStock extends AppCompatActivity implements AdapterView.OnItemClickListener {
    private ListView upStock_listView;
    private Handler upStockhandler =new Handler(){
        public void handleMessage(Message msg){
            ...
            if(allStock!=null&&allStock.size()>0){
                ...
                upStock_listView.setAdapter(listAdapter);
            }
        }
    };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upStock_listView =(ListView)findViewById(R.id.upStock_listView);
...
//                        .order("publishdate desc").limit(10).find(News.class);
        ...
        //3.设置listview条目的点击事件
        upStock_listView.setOnItemClickListener(this);
    }
