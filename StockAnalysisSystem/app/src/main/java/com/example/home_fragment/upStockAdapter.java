...
public class upStockAdapter extends BaseAdapter {
    private List<StockInfoDB> list;
    private Context context;
    public upStockAdapter(Context context, List<StockInfoDB> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        changePercent.setText(String.format("%.3f",stock.getChange_percent())+"%");
        changePercent.setTextColor(Color.parseColor("#990101"));
