...
public class yqStockAdapter extends BaseAdapter {
    static Stock stock=new Stock();

    String gid;
    private List<yqStock>list;
    private Context context;
    private LayoutInflater inflater;
    private String categoryID;
    public yqStockAdapter(Context context, List<yqStock> list1, String category){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        yqStock yqStock1=list.get(position);

        //2.获取view上的子控件对象
        TextView yqStock_name=(TextView)view.findViewById(R.id.health_china_stock_name);
        TextView yqStock_symbol=(TextView)view.findViewById(R.id.health_china_stock_symbol);
        TextView yqStock_now_price=(TextView)view.findViewById(R.id.health_china_now_price);
        TextView yqStock_change_price=(TextView)view.findViewById(R.id.health_china_change_price);
        TextView yqStock_change_percent=(TextView)view.findViewById(R.id.health_china_change_percent);
        TextView yqStock_theme_name=(TextView)view.findViewById(R.id.health_china_theme_name);
        ...
        //4.将数据设置给这些子控件做显示
        yqStock_name.setText(yqStock1.getName());
        yqStock_symbol.setText(yqStock1.getGid());
        yqStock_now_price.setText(stock.getTrade());
        yqStock_change_price.setText(stock.getPricechange());
        yqStock_change_percent.setText(stock.getChangepercent());
        yqStock_theme_name.setText(categoryID);
        return view;
    }
}
