...
public class hkStockActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                //请求网络数据
                ArrayList<Stock> allNews = hk_HttpRequestForList.getAllStockList(getBaseContext(), StockAPI.getHKAll(1));
    ...
    public void onClick(View v) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                //请求网络数据
                ArrayList<Stock> allStocks = hk_HttpRequestForList.getAllStockList(getBaseContext(), StockAPI.getHKAll(np));
                //通过handler将msg发送到主线程去更新Ui
                Message msg = Message.obtain();
                msg.obj = allStocks;
                handler.sendMessage(msg);
