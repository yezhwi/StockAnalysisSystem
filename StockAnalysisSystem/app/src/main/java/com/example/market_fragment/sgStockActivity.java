...
public class sgStockActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                //请求网络数据
                ArrayList<Stock> allNews = HttpRequestForList.getAllStockList(getBaseContext(), StockAPI.getSGAll(1));
...
//        startActivity(intent);
    ...
    public void onClick(View v) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                //请求网络数据
                ArrayList<Stock> allStocks = HttpRequestForList.getAllStockList(getBaseContext(), StockAPI.getSGAll(np));
                //通过handler将msg发送到主线程去更新Ui
                Message msg = Message.obtain();
                msg.obj = allStocks;
                handler.sendMessage(msg);
