...
public class usStockActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                //请求网络数据
                ArrayList<Stock> allStocks= us_HttpRequestForList.getAllStockList(getBaseContext(), StockAPI.getUSAAll(1));;
    ...
    public void onClick(View v) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                //请求网络数据
                ArrayList<Stock> allStocks = us_HttpRequestForList.getAllStockList(getBaseContext(), StockAPI.getUSAAll(np));;
                //通过handler将msg发送到主线程去更新Ui
                Message msg = Message.obtain();
                msg.obj = allStocks;
                handler.sendMessage(msg);
